...
public class Application {
	...
	// new method by me:
	public void addAppModule(String moduleName, int ram, double mips, double 
			moduleDataSize, long bw, int classification, List<String> sensorsName, Sensor sensors,  double maxResponseTime, long issueTime, long finishTime, double partialDataSize){
			String vmm = "Xen";
			AppModule module = new AppModule(FogUtils.generateEntityId(), 
			moduleName, appId, userId, 
			mips, ram, bw, moduleDataSize, vmm, new TupleScheduler(mips, 1), 
			new HashMap<Pair<String, String>, SelectivityModel>(), classification, sensorsName, sensors, maxResponseTime, issueTime, finishTime,partialDataSize);
			getModules().add(module);
			}
	/**
