...
public class Controller extends SimEntity{
	...
	//------------------------------------------------------------------------
	private List<FogDevice> sinksMobile;
	...
	public Controller(String name, List<FogDevice> fogDevices, List<Sensor> sensors, List<Actuator> actuators, List<FogDevice> sinksMobile) {
		super(name);
		...
		// Firstly, put seed=3 and step policy=1 as proposed by the myiFogSim, later I can make it configured when the application is run
		setStepPolicy(1);
		setSeed(30); 
	...
	public List<FogDevice> getSinksMobile() {
		return sinksMobile;
	}

	public void setSinksMobile(List<FogDevice> sinksMobile) {
		this.sinksMobile = sinksMobile;
	}
	public static Coordinate getCoordDevices() {
		return coordDevices;
	}
	public static void setCoordDevices(Coordinate coordDevices) {
		Controller.coordDevices = coordDevices;
	}
	public static int getStepPolicy() {
		return stepPolicy;
	}
	public static void setStepPolicy(int stepPolicy) {
		Controller.stepPolicy = stepPolicy;
	}
	public static Random getRand() {
		return rand;
	}
	public static void setRand(Random rand) {
		Controller.rand = rand;
	}
