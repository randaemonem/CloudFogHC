...
public class FogEvents {
	...
	//-----------------------------------------------------
	public static final int NEXT_STEP = BASE+26;
	public static final int CHECK_NEW_STEP = BASE+27;
	public static final int START_HANDOFF = BASE+28;
	public static final int UNLOCKED_HANDOFF = BASE+29;
